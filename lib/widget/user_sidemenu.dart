...
// class UserSidemenu extends StatelessWidget implements PreferredSizeWidget {
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            title: Text('My Request', style: GoogleFonts.poppins(fontSize: 14)),
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => travel_request_details()),
            ),
          ),
          ListTile(
            leading: Icon(Icons.list),
            title: Text('Proposals', style: GoogleFonts.poppins(fontSize: 14)),
            onTap: () => Navigator.push(
              context,
